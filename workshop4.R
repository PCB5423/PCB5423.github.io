...
#   where $N_t$ is the population size at time $t$, $K$ is the carrying capacity of the population, and $r_d$ is the discrete growth factor. It is important to know that 
# $r_d = \lambda -1$. \
...
rd = 1.2 #geometric growht factor
...
# 
# Using `mutate()` we can calculate the population growth increment ($\Delta N_t$) and the per capita growth ($\Delta N_t/N_t$). The population growth is the $r_dN_t(1-N_t/K)$ of the equation.
