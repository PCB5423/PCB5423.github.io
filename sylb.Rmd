...
-    Quick-R by datacamp: Quick overview on R programming and statistical approaches.There are more tutorials but you will require to register\
...
-   *Participation* – Due to the limited number of sessions, I will provide a participation point for only one missed session with a validated and accepted excuse. -   *Homework* – Make-up alternatives only for medical (including COVID-19) emergencies. The make-up will consist of submitting the homework materials at a later date (e.g., 48-72 hours after the submission deadline), depending on the gravity of the emergency.  
-   *R project* -  No make-up alternatives for this assignment. An incomplete final grade will be submitted if, for some acceptable reason/excuse, a student can't finish and submit the R project report.
